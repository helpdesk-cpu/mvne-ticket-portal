// ---------------------------------------------------------------------------
// Ticket portal configuration for the Canal+ branded page
// (canal-connect.html). Same Zammad backend as the generic portal
// (assets/config.js) - kept as a separate file so Canal+-specific
// categories/limits/extra fields can diverge without touching the other
// branded pages.
// ---------------------------------------------------------------------------
      ...
      extraFields: [
        {
          ...
          hint: "The ICCID of the new SIM being swapped in - scan it the same way as above.",
          required: true,
        },
      ],
    },
